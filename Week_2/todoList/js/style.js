...
var Time = ()=>{
    ...
    if(container.classList.contains("english")){
...
search.addEventListener("click",()=>{
    ...
    if(searchInput.value!=""){
        search.addEventListener("click",()=>{
            main.querySelectorAll(".todoItem").forEach(todoItem=>{todoItem.remove()});
            searchItem();
        })
        ...
        if(result==0){
            ...
            // }else{
                if(container.classList.contains("english")){
                    ...
                    err.innerHTML = "查询不到该笔记！"//这里英文版的要修改
                }
